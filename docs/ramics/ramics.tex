...
by other peers made an individual choice. Similarly to spending-signed currencies, every spender is signing and backing a
note.

We have implemented our proposal in software. The core concept is a payment server.
\end{abstract}
