...
In this work, we propose a new global peer-to-peer network based money system, with decentralized issuance, individual acceptance rules and elastic supply, called \cc{}. \cc{} notes are
...
The paper is organized as follows. In Section~\ref{sec-design} ...
