...
On-chain contracts and reference server implementations are open-sourced and available under public domain license~\footnote[1]{A link to source code will be provided in a final version of the paper}.
