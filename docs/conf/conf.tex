...
details on implementation. In Section~\ref{sec-apps} we outline possible applications on top of \cc{}. In Section~\ref{sec-comparison} comparison
 with other monetary systems and blockchain protocols provided. It is possible to witdraw funds from a reserve by simply issuing a note, then spending with a signature
...
Local exchange trading system (LETS) is a form of non-collateralized community currency, where any member of a community
