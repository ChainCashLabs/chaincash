...
For blockchain-based \cc{} implementation, we consider how to implement two main parts:

\begin{itemize}
  \item{} contracts for notes, reserves, and redemption receipts. Here, we consider on-chain contracts as the most
  straightforward option. Then we may consider more scalable option, such as having reserves (and maybe receipts) only
